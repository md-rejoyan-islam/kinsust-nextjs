export const socialAwarenessSVG = () => {
  return (
    <svg
    ...
    >
      <g>
        <g data-name="hand recieve cloathes">
          <path fill="#6fabe6" d="M1 23h6v17H1z" data-original="#6fabe6"></path>
          <path
            fill="#82bcf4"
