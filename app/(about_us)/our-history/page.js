...
import Map from "../../../components/our-history/Map";

export default function page() {
  return (
    <article className=" bg-[#fff]  m-auto pb-5  text-slate-800  theme-dark ">
      <section className="">
        <section>
          <PhotoPreview src="/images/history/hand.webp">
            <Image
              src="/images/history/hand.webp"
        ...
        <section className="xl:w-[1200px]   m-auto mt-12 px-5 ">
          ...
          <div className="place-items-center py-16 m-auto grid grid-cols-12">
            ...
            <figure className="col-span-5 xl:col-span-4">
              <PhotoPreview src="/images/history/map.png">
                <Image
