...
import ScrollInViewMotion from "../ScrollInViewMotion";
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-1 grid-cols-1">
              <div className="pb-12">
                <h1 className="lg:text-2xl md:text-2xl font-bold py-2 text-[19px] text-[#24272abd] dark:text-[#b6bfcb]      ">
                  ৳&nbsp;
                  <AnimatedCount from={0} to={880530} duration={2} />
                </h1>
              ...
              <div className="pb-12">
                <h1 className="lg:text-2xl md:text-2xl font-bold py-2 text-[19px] text-[#292f33bd] dark:text-[#b6bfcb]     ">
                  <AnimatedCount from={0} to={1600} duration={2} />
              ...
              <div className="pb-12">
                <h1 className="lg:text-2xl md:text-2xl font-bold py-2 text-[19px] text-[#292f33bd] dark:text-[#b6bfcb]     ">
                  <AnimatedCount from={0} to={200} duration={2} />
              ...
              <div className="pb-12">
                <h1 className="lg:text-2xl md:text-2xl font-bold py-2 text-[19px] text-[#292f33bd] dark:text-[#b6bfcb]     ">
                  <AnimatedCount from={0} to={21} duration={2} />
                </h1>
                <p className="text-[19px]  md:text-xl text-[#242a50] font-bold dark:text-[#f5d9d3]">
                  Villages reached
                </p>
          ...
          <div className="w-1/2">
            ...
            <div className="grid lg:grid-cols-2  grid-cols-1">
              <div className="pb-12">
                <h1 className="lg:text-2xl md:text-2xl font-bold py-2 text-[19px] text-[#292f33bd] dark:text-[#b6bfcb]     ">
                  ৳&nbsp;
                  <AnimatedCount from={0} to={360593} duration={2} />
                </h1>
                <p className="text-[19px]  md:text-xl text-[#242a50] font-bold dark:text-[#f5d9d3]">
                  Donation Managed
                </p>
              ...
              <div className="pb-12">
                <h1 className="lg:text-2xl md:text-2xl font-bold py-2 text-[19px] text-[#292f33bd] dark:text-[#b6bfcb]    ">
                  <AnimatedCount from={0} to={727} duration={2} />
              ...
              <div className="pb-12">
                <h1 className="lg:text-2xl md:text-2xl font-bold py-2 text-[19px] text-[#292f33bd] dark:text-[#b6bfcb]     ">
                  ৳&nbsp;
                  <AnimatedCount from={0} to={3256} duration={2} />
                  <span>+</span>
                </h1>
                <p className="text-[19px]  md:text-xl text-[#242a50] font-bold dark:text-[#f5d9d3]">
                  Clothes
