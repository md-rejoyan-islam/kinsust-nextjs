...
function ProgramCard({ program, title }) {
        ...
        <div className="my-3">
          <div className="card-actions justify-center w-full">
            <Link
              ...
              target={"_blank"}
              className="z-10 my-2  bg-transparent text-violet-600 border-violet-600  dark:border-violet-700 dark:bg-violet-900 dark:text-white   border py-2 flex items-center w-full text-center dark:hover:bg-violet-800 justify-center gap-2 rounded-md px-3 "
            >
              <svg
                stroke="currentColor"
                fill="none"
