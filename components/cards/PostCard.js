...
export default function PostCard({ post, index }) {
  ...
  return (
    <Glow>
      ...
      >
        <div
          className=" text-black border-4 glow:bg-green-200 dark:glow:bg-violet-600/20 glow:border-green-400 dark:glow:border-violet-600    dark:bg-[#182c496b]  dark:text-white dark:border-[#2d2254] bg-[#fff]  border-slate-100 rounded-[8px] z-10  flex  lg:mx-24 flex-col md:flex-row max-w-[400px] mx-auto md:max-w-full my-5"
          ref={viewRef}
        >
          <figure className="basis-2/5 z-10 flex items-stretch cursor-pointer">
            <PhotoPreview
            ...
            >
              <Image
                ...
                loading="lazy"
                className="md:rounded-l-md rounded-t-md md:rounded-tr-none  object-cover w-full h-full max-h-[250px] "
              />
            </PhotoPreview>
          </figure>
          <div className="pb-2 basis-3/5 p-5   z-10 flex flex-col justify-between">
            <div className="">
              ...
              {/* small display */}
              <p className="md:hidden text-justify text-[17px]" id="details">
                {post?.banner?.split(" ").slice(0, 17).join(" ")}. . .
              </p>
