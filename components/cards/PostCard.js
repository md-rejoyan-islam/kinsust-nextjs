...
export default function PostCard({ post, index }) {
  ...
  return (
    ...
    >
      <div
        className=" text-black border hover:bg-violet-50 hover:scale-[1.01] transition-all duration-300 dark:bg-[#182c496b] dark:hover:bg-[#182c49dc] dark:text-white dark:border-[#2d2254] bg-[#fff] border-violet-200 rounded-[8px] z-10  flex  lg:mx-24 flex-col md:flex-row max-w-[400px] mx-auto md:max-w-full my-5"
        ref={viewRef}
      >
        ...
        <div className="pb-2 basis-3/5 p-5  dark:hover:bg-[#150f31b9] z-10 flex flex-col justify-between">
          <div className="">
            <h3 className="font-bold  text-2xl text-justify">{post?.title}</h3>
