...
function ProgramCard({ program, title, index }) {
  ...
  const formatDate = (date) => {
    return new Date(date)
      ...
      .replace(/(\w+) (\d+), (\d+)/, function (_, month, day, year) {
    ...
    >
      ...
      <div className=" card-body  dark:text-[#cdd6e2] text-black">
        ...
        <p className="flex gap-4">
          ...
          <span className="font-['Hind_Siliguri']">{program?.venue}</span>
        </p>
        <p className="flex gap-4">
          <span>
            <svg
        ...
        <div className="my-3">
          <div className="card-actions justify-center w-full">
            <Link
              ...
              target={"_blank"}
              className="z-10 my-2  hover:bg-violet-50 bg-transparent text-violet-600 border-violet-600  dark:border-violet-700 dark:bg-violet-900 dark:text-white   border py-2 flex items-center w-full text-center dark:hover:bg-violet-800 justify-center gap-2 rounded-md px-3 "
            >
              <svg
                stroke="currentColor"
                fill="none"
